...
var collectionName = "customers"; //main collection name
var interval = 200; //insert data interval in miliseconds
var insertCustomers = function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, db, collection, customers, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                customers = Array.from({ length: faker_1.faker.number.int({ min: 1, max: 10 }) }, function () { return ({
                ...
                return [4 /*yield*/, collection.insertMany(customers)];
            case 3:
                _a.sent();
